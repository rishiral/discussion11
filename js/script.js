...
document.querySelector("#host-name").innerHTML = "Rishi";
document.querySelector("#collaborator-name").innerHTML = "Elissa";
// Question 2
...
document.querySelector("#password").addEventListener("oninput", check_password);
